...
\newcommand{\teamName}{DU\_Primordius}
\newcommand{\firstMember}{\color{Dandelion}fahimcp495}
\newcommand{\secondMember}{\color{RedViolet}\_timelord}
\newcommand{\thirdMember}{\color{Dandelion}Shakil17}
\newcommand{\contestName}{ICPC Dhaka Regional 2024}
